            ...
            <div class="hero">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    <div class="text-center lg:text-left">
                        ...
                        <progress class="progress progress-secondary w-96" value="90" max="100"></progress><br/>
                        <div className='flex justify-between'>
                            <h4>CSS</h4>
                            <h4>80%</h4>
                        </div>
                        <progress class="progress progress-secondary w-96" value="80" max="100"></progress><br/>
                        <div className='flex justify-between'>
                            <h4>JS</h4>
                            <h4>80%</h4>
                        </div>
                        ...
                        <progress class="progress progress-secondary w-96" value="70" max="100"></progress><br/>
                        <div className='flex justify-between'>
                            <h4>Node Js</h4>
                            <h4>60%</h4>
                        </div>
                        <progress class="progress progress-secondary w-96" value="60" max="100"></progress><br/>
                    </div>
                    <div class="text-center lg:text-left">
                        <h1 class="text-4xl font-bold">My creative skills & experiences.</h1>
